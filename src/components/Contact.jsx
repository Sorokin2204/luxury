...
export class Contact extends Component {
	...
	{/* Title page */}
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style={{ backgroundImage: `url(${this.images['bg-01.jpg'].default})`}}>
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form>
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							<img class="how-pos4 pointer-none" src={this.images['icons/icon-email.png'].default} alt="ICON"/>
						</div>
	...
	{/* Map */}
	<div class="map">
		<div class="size-303" id="google_map" data-map-x="40.691446" data-map-y="-73.886787" data-pin={this.images["icons/pin.png"].default} data-scrollwhell="0" data-draggable="1" data-zoom="11"></div>
	</div>
